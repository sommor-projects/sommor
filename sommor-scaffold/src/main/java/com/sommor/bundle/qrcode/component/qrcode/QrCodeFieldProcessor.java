...
public class QrCodeFieldProcessor implements
    ...
    @Override
    public Object processOnFieldFill(QrCodeFieldConfig config, com.sommor.model.fill.FieldFillContext ctx) {
    ...
    @Override
    public void processOnFormSaving(QrCodeFieldConfig qrCodeFieldConfig, com.sommor.component.form.FieldSaveContext ctx) {
